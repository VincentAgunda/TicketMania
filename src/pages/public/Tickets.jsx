    ...
    <div className={`${glassClass} overflow-hidden`}>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-200">
              <div className="flex items-center space-x-2">
                ...
                <span>{formatDate(ticket.matches.match_date)}</span>
              </div>
              <div className="flex items-center space-x-2">
                <LocationOn className="h-4 w-4 text-yellow-300" />
                <span>{ticket.matches.venue}</span>
              </div>
              <div className="flex items-center space-x-2">
      ...
      <div className="px-6 py-3 border-t border-white/20 flex justify-between items-center text-sm text-gray-200">
        ...
        <button
          ...
          className="flex items-center space-x-1 hover:underline text-yellow-300"
        >
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Ticket Sections */}
        <TicketSection title="Active Tickets" tickets={activeTickets} emptyMessage="No active tickets found" />
        <TicketSection title="Used Tickets" tickets={usedTickets} emptyMessage="No used tickets found" />
        <TicketSection title="Cancelled Tickets" tickets={cancelledTickets} emptyMessage="No cancelled tickets found" />
