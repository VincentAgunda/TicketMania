...
const Matches = () => {
  ...
  const [dateFilter, setDateFilter] = useState('upcoming') // Default to upcoming
    ...
    if (matches) {
      ...
      const sorted = [...filtered].sort((a, b) => {
        ...
        switch (sortBy) {
          ...
          case 'availability':
            return (b.available_seats / b.total_seats) - (a.available_seats / a.total_seats)
          default:
            return 0
        }
      })
  ...
  }, [matches, searchTerm, dateFilter, sortBy, currentTime]) // Added currentTime dependency
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredMatches.map((match, index) => (
              <MatchCard 
                ...
                match={match} 
                shadeIndex={index}
                currentTime={currentTime} // Pass current time to MatchCard for real-time updates
              />
            ))}
          </div>
        ) : (
